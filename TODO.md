...
- [ ] Connect `mixing_assistant.py` to a real LLM backend API (OpenAI/Anthropic or local inference).
- [ ] Refine the system prompt in the mixing assistant to provide the LLM with the exact current track list and available OSC address schema of the running DAWs.
